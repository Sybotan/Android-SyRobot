...
import com.sybotan.SyRobot.activities.ExitActivity
import com.sybotan.SyRobot.preferences.Opts
import com.sybotan.SyRobot.robots.LittleStar
import com.sybotan.SyRobot.robots.Robot
...
class SyRobot : Application() {
    companion object {
        ...
        fun loadRobot(name: String): Robot? {
            try {
                val clazz = Class.forName("com.sybotan.SyRobot.robots.$name") ?: return null
