...
package com.sybotan.android.syrobot.widgets
...
import kotlinx.android.synthetic.main.widget_joystick.view.*
 ...
 * @author  Andy
 */
class JoystickWidget(context: Context, attrs: AttributeSet? = null) : RelativeLayout(context, attrs) {
    companion object {
        private val TAG = JoystickWidget::class.java.simpleName
    } // companion object
    ...
    init {
        // 加载布局
        LayoutInflater.from(context).inflate(R.layout.widget_joystick, this)
